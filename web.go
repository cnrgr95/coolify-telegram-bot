...
func startWebPanel() {
	...
	port:=os.Getenv("PORT"); if port=="" {port="8080"}; log.Printf("Web panel listening on :%s",port); log.Fatal(http.ListenAndServe(":"+port,nil))
}
